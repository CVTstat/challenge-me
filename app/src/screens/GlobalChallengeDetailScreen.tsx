...
const styles = StyleSheet.create({
  ...
  description: { color: "#6b7f70", marginTop: 4 },
  goal: { marginTop: 12, fontSize: 15 },
  reward: { color: "#f59e0b", marginTop: 4 },
  limited: { color: "#e8415a", marginTop: 8, fontWeight: "600" },
  consentBox: {
    flexDirection: "row",
    alignItems: "center",
    gap: 12,
    marginTop: 24,
    backgroundColor: "#ffffff", borderWidth: 1, borderColor: "#e7ede8",
    borderRadius: 12,
    padding: 14,
  },
  consentText: { flex: 1, fontSize: 13, color: "#1b2a20" },
  primaryButton: { backgroundColor: "#e8415a", borderRadius: 8, padding: 14, marginTop: 20 },
