...
const styles = StyleSheet.create({
  ...
  hint: { color: "#6b7f70", fontSize: 13, marginTop: 4, marginBottom: 12, lineHeight: 18 },
  linkBox: { backgroundColor: "#ffffff", borderWidth: 1, borderColor: "#e7ede8", borderRadius: 8, padding: 12, marginBottom: 12 },
  linkText: { color: "#1b2a20", fontSize: 13 },
  row: { flexDirection: "row", gap: 10 },
  flex1: { flex: 1 },
  primaryButton: { backgroundColor: "#e8415a", borderRadius: 8, padding: 12 },
  ...
  divider: { height: 1, backgroundColor: "#e7ede8", marginVertical: 24 },
  input: { borderWidth: 1, borderColor: "#e7ede8", borderRadius: 8, padding: 12, backgroundColor: "white" },
  messageInput: { marginTop: 10, minHeight: 60, textAlignVertical: "top" },
  empty: { color: "#6b7f70", marginTop: 16, textAlign: "center" },
  userRow: {
    flexDirection: "row",
    alignItems: "center",
    ...
    paddingVertical: 10,
    borderBottomWidth: 1,
    borderBottomColor: "#e7ede8",
  },
  userName: { fontSize: 15, fontWeight: "600" },
  inviteButton: { backgroundColor: "#e8415a", borderRadius: 8, paddingVertical: 8, paddingHorizontal: 14 },
  inviteButtonDone: { backgroundColor: "#9aab9f" },
