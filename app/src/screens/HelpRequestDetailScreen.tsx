...
const styles = StyleSheet.create({
  ...
  questionCard: { backgroundColor: "#fff7ed", borderRadius: 12, padding: 16 },
  questionBody: { fontSize: 16 },
  questionMeta: { color: "#888", marginTop: 8, fontSize: 13 },
  ...
  guideLabel: { color: "#666" },
  replyCard: { backgroundColor: "#f7f7f8", borderRadius: 12, padding: 14, marginBottom: 8 },
  replyBody: { fontSize: 15 },
  helpfulAction: { color: "#555", marginTop: 8, fontSize: 13 },
  helpfulActive: { color: "#16a34a", marginTop: 8, fontSize: 13, fontWeight: "600" },
